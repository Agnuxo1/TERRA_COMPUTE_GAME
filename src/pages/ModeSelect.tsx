...
const modes = [
  ...
  },
  {
    ...
    startYear: 1980,
    color: '#00F0FF',
    description: 'The real race begins. Rivals compete, but a strong AGI program can still win before the window closes.',
    features: ['Start in 1980', '7 AI rivals', 'AGI + 5ZF goal', 'Unlocks: Completo'],
