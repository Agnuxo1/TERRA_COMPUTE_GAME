...
const mooreDifficulties: Array<{
...
}> = [
  {
    ...
    label: 'I',
    name: 'NOT GATE',
    description: 'One transistor controlled by inverted current. Learn open vs closed.',
    gateLabel: 'NOT A',
  },
  {
    id: 2,
    label: 'II',
    name: 'SERIES AND',
    description: 'Two transistors in series: current passes only when both controls are powered.',
    gateLabel: 'A AND B',
  },
  {
    id: 3,
    label: 'III',
    name: 'PARALLEL OR',
    description: 'Two transistor lanes in parallel: either powered lane can drive the output.',
    gateLabel: 'A OR B',
  },
  {
    id: 4,
    label: 'IV',
    name: 'XOR CROSSING',
    description: 'Two lanes represent opposite states, the classic exclusive-or puzzle.',
    gateLabel: 'A XOR B',
  },
  {
    id: 5,
    label: 'V',
    name: 'MAJORITY CELL',
    description: 'A compact three-input decision circuit: two powered inputs are enough.',
    gateLabel: 'MAJORITY',
  },
];
